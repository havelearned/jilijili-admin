...
import wang.jilijili.system.pojo.dto.QueryDto;
...
@Slf4j
public class BaseController<T extends SuperEntity, M extends BaseMapper<T>, S extends IService> implements UserDetailsService {
    protected M mapper;
    protected S service;
    ...
    public void export(QueryDto queryDto, HttpServletResponse response) {
        ...
        try (ExcelWriter writer = ExcelUtil.getWriter()) {
            ...
            List<T> userList = this.mapper.selectList(queryWrapper);

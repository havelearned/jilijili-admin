...
import lombok.Data;
import top.jilijili.system.common.enums.StatusCodeEnum;

import static top.jilijili.system.common.enums.StatusCodeEnum.FAIL;
import static top.jilijili.system.common.enums.StatusCodeEnum.SUCCESS;
...
public class Result<T> {
    ...
    public static <T> Result<T> ok(T data, Boolean flag) {
        return restResult(flag, data, SUCCESS.getCode(), null);
    }

    public static <T> Result<T> ok(T data, String message, Boolean flag) {
        return restResult(flag, data, SUCCESS.getCode(), message);
    }

...
import top.jilijili.common.constant.RoleConstant;
import top.jilijili.common.enums.OperationType;
import top.jilijili.common.core.pojo.bo.SysDictCovertBo;
...
import top.jilijili.common.core.service.SysDictDataService;
import top.jilijili.common.core.service.SysDictTypeService;
...
public class SysDictTypeController {
     ...
     */
    @PostMapping("/")
    @RolesAllowed(value = {RoleConstant.ROLE_SUPER_ADMIN})
    @JilJilOperationLog(moduleName = ModuleNameConstant.DICT_MANAGE, type = OperationType.ADD)
    ...
    @PutMapping("/")
    @RolesAllowed(value = {RoleConstant.ROLE_SUPER_ADMIN})
    @JilJilOperationLog(moduleName = ModuleNameConstant.DICT_MANAGE, type = OperationType.UPDATE)
    ...
    @RolesAllowed(value = {RoleConstant.ROLE_SUPER_ADMIN})
    @JilJilOperationLog(moduleName = ModuleNameConstant.DICT_MANAGE, type = OperationType.DELETED)

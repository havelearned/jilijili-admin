package top.jilijili.common.aspect;
...
import top.jilijili.common.annotation.NoRepeatSubmit;
import top.jilijili.common.utils.IpUtils;
import top.jilijili.common.core.pojo.vo.Result;
import top.jilijili.common.core.service.RedisService;

import java.lang.reflect.Method;

import static top.jilijili.common.constant.RedisKeyConstant.KEY_NO_REPEAT_SUBMIT;
...
public class RepastSubmitAspect {
    ...
    @Pointcut(value = "@annotation(top.jilijili.common.annotation.NoRepeatSubmit)")
